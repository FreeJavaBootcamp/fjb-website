    ...
    <div class="row">
        <div class="col-md-6">
            <div class="hero-content">
                ...
                <p class="lead">The Free Java Bootcamp offers a comprehensive and accessible program for individuals of
                    all backgrounds to master Java programming. With expert-led instruction, hands-on learning, and a
                    supportive community, learners can gain the skills and resources needed to excel in Java
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="activity">
                <br/><br/>
                <h3>Workshops</h3>
                <p>The Free Java Bootcamp workshops are engaging and interactive sessions held three times a week, each
                    lasting 30 minutes. Led by experienced instructors, these workshops provide a supportive environment
                    to enhance your Java programming skills through expert instruction, hands-on exercises, and
